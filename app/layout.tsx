...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      prose-h2:text-heading2 prose-h2:font-normal prose-h2:text-dark-gray prose-h2:font-nunito prose-h2:uppercase prose-h2:tracking-h2 prose-h2:mb-9
      prose-h3:text-heading3 prose-h3:font-normal prose-h3:text-gray prose-h3:font-roboto_slab
